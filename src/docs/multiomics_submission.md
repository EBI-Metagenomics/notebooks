...
[Figure 3. An extract of the samples table displayed in MetaboLights for Holofood chicken data (accession MTBLS6988)](images/multiomics/metabolights_example.png){#metabolights_example .tall-figure fig-align="left"}
