---
title: Assembly Annotation Pipeline v6.0
author:
  - name: MGnify
...
The following sections describe the pipeline implementation and reference databases. You do not need to run Nextflow or use these resources to view results on MGnify.
