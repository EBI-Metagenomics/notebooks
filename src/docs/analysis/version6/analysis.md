...
Analysed assembled datasets are complemented by [VIRify](virify.md) for viral sequence detection and the [Mobilome annotation pipeline](mobilome.md), both accessible in the same web view.
...
## Current MGnify Analysis versions

- Amplicon analysis - [v6.2](amplicon.md)
...
- Results from different analysis versions, such as `v6.0` and `v6.1`, should not be assumed to be directly comparable due to potential differences in pipeline outputs.
...
The MGnify analyses provides three pipelines, selected according to the type of sequence data being analysed.
