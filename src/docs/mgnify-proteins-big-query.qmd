...
This should be sufficient for running a number of queries on the MGnify Protein Database, 
...
| study_id          | INTEGER  | INTEGER   | Study ID                                                               |
| biome_id          | INTEGER  | INTEGER   | Biome ID                                                               |
