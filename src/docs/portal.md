...
MGnify’s [Studies](glossary.md#term-Study), [Samples](glossary.md#term-Sample), and [Analyses](glossary.md#term-Analysis-result)
are indexed so that they can be searched for by name, description, accession, [biome](glossary.md#term-Biome) and more.
This is the quickest way to get started finding [metagenomics](glossary.md#term-Metagenomic)-derived data.
...
You can submit your own metagenomic data for analysis using our [pipeline](glossary.md#term-Pipeline),
...
To appear in MGnify, an ENA Study is submitted for analysis by the MGnify [pipeline](glossary.md#term-Pipeline).
...
They represent (the genetic sequencing of) a single real-world specimen from a particular [biome](glossary.md#term-Biome).
Samples have accessions assigned by the source database, e.g. prefixed ERS by ENA.

The sequencing [runs](glossary.md#term-Run), [assemblies](glossary.md#term-Assembly) and [analyses](glossary.md#term-Analysis-result) can be explored
...
Genomes within MGnify are metagenomic-assembled genomes ([MAGs](glossary.md#term-MAGs)) organised into biome-specific catalogues
...
The detail page for a [Sample](glossary.md#term-Sample) in MGnify shows
...
The [Sample](glossary.md#term-Sample) detail pages also show a link to an entry in the
...
Some [Samples](glossary.md#term-Sample) have additional metadata from [Elixir’s Contextual Data Clearing House](https://elixir-europe.org/internal-projects/commissioned-services/establishment-data-clearinghouse).
...
MGnify present additional metadata that may be relevant to a [Study](glossary.md#term-Study) or [Sample](glossary.md#term-Sample) using automated text-mining on
...
refer to. However, on the [Sample](glossary.md#term-Sample) pages within MGnify the existence of any potential additional metadata from
associated [studies’](glossary.md#term-Study) publications is highlighted beneath the main metadata listing.
...
This table lists all [samples](glossary.md#term-Sample) and [runs](glossary.md#term-Run) associated with a project as well as the experiment type ([Amplicon](glossary.md#term-Amplicon), [Assembly](glossary.md#term-Assembly), [Metabarcoding](glossary.md#term-Metabarcoding), [Metagenomic](glossary.md#term-Metagenomic) or [Metatranscriptomic](glossary.md#term-Metatranscriptomic)), sequencing instrument model and pipeline version for each individual run.
In addition, the last field displays links to analysis results and download pages (the latter being represented by the 

![image](images/portal/download_IC.png)

 icon).

## Finding quality control information about runs on the MGnify website

Quality control (QC) analysis of runs within projects on the [MGnify website](https://www.ebi.ac.uk/metagenomics/) can be accessed by selecting the ‘Quality control’ tab found toward the top of any run page (see Figure 1 below).
...
Functional analysis of runs within projects on the [MGnify website](https://www.ebi.ac.uk/metagenomics/) can be accessed by selecting the ‘Functional Analysis’ tab found toward the top of any run page (see Figure 4 below). Note that this tab will be greyed for amplicon runs that have no functional results.
...
Taxonomic analysis of runs within projects on the [MGnify website](https://www.ebi.ac.uk/metagenomics/) can be accessed by selecting the ‘Taxonomic analysis’ tab found toward the top of any run page (see Figure 7 below).
...
The Search tool is underpinned by [EBI search](https://www.ebi.ac.uk/ebisearch/overview.ebi)  and accessible via any MGnify page (Figure 11 below).
